            ...
            <div className="mt-8 sm:mt-10">
              ...
              >
                ...
                <CtaEcho className="items-center whitespace-nowrap">
                  <span className="font-body font-bold text-[1rem] sm:text-[1.125rem] lg:text-[1.25rem] whitespace-nowrap text-white">
        ...
        <div className="max-w-[min(100%,120rem)] mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-4 w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 lg:gap-10">
            ...
            <Link
              ...
              className="flex flex-col items-center sm:items-start w-[13.125rem] cursor-pointer"
            >
              <Image
                ...
                height={100}
                sizes="13.125rem"
                className="w-[13.125rem] h-auto object-contain block"
              />
              <p className="text-[0.7625rem] font-medium text-[#f5f4ea] font-sans -ml-[1px] whitespace-nowrap mt-1 text-center sm:text-left">
                {SLOGAN}
              </p>
            </Link>
