...
export function Depoimentos() {
  ...
  return (
    <Section id="depoimentos" tone="paper" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="pad">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 [mask-image:linear-gradient(to_bottom,transparent_0%,black_12%,black_88%,transparent_100%)] max-h-[640px] md:max-h-[720px] overflow-hidden">
