...
export function Problema() {
  ...
  return (
    <Section id="problema" tone="ink" className="rule-t w-full">
      {/* ─── A. PARA QUEM É ─────────────────────────────────────── */}
      ...
      <div className="w-full rule-t">
        <Reveal stagger={0.08} className="cols md:grid-cols-3 max-w-[min(100%,120rem)] mx-auto">
      ...
      <div className="rule-t pad py-10 md:py-12">
        <div className="max-w-[min(100%,120rem)] mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 md:gap-8">
      ...
      <div className="t-paper bg-paper rule-t pad py-16 md:py-20 w-full">
        <div className="max-w-[min(100%,120rem)] mx-auto">
          <h2 className="max-w-[20ch] font-display text-h2 text-balance">
      ...
      <div className="t-ink bg-ink rule-t pad py-16 md:py-24 flex flex-col justify-center w-full">
